...
contract Pausable is Ownable {
    ...
    event Unpased(address _address);
}
...
//    @dev Approves another address to transfer the given token ID
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] != to, 'Token for owner already exists');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_operatorApprovals[from][to] == true, 'Not a valid adress');
...
contract ERC721MintableComplete is ERC721Metadata {
    ...
    function mint(address to, uint tokenId) public onlyOwner returns (bool) {
        ...
        string memory uri = super.setTokenURI(tokenId);
